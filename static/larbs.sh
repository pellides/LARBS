...
dotfilesrepo="https://github.com/pellides/dotfiles.git"
progsfile="https://raw.githubusercontent.com/pellides/LARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
localectl set-x11-keymap latam,gr thinkpad ,polytonic grp:alt_shift_toggle
